...
public final class WeatherForecast {
    ...
    public WeatherForecastApiResponse toApiResponse() {
        List<DailyTemperatureApiResponse> dailyTemperatures = this.dailyTemperatures.stream()
                .map(temperature -> new DailyTemperatureApiResponse(temperature.getDate(), temperature.getTemperature()))
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(dailyTemperatures, that.dailyTemperatures);
    }

    @Override
    public int hashCode() {
        return Objects.hash(dailyTemperatures);
    }
    ...
    public static final class DailyTemperature {
        ...
        public boolean equals(Object o) {
            ...
            return Double.compare(that.temperature, temperature) == 0 && Objects.equals(date, that.date);
        }
